# -*- coding: utf-8 -*-
"""3-1.(실습)img_CNN모델_horses or humans

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1J_GCRa3ufaLSYnsv7ar8YRP89laQmAeR
...
# train data에는 옵션값 넉넉히 설정해준다. (이미지가 복잡함)
...
# validation data 에는 rescale만!! 검증용도니까 테스트처럼 옵션넣을필요없다. 
...
train_generator = training_datagen.flow_from_directory(  # 변수값 주의!
    TRAINING_DIR,  # 경로 주의! 
    target_size=(300, 300),  
    batch_size=32,
    class_mode='categorical',
...
validation_generator = validation_datagen.flow_from_directory(  # 변수값 주의!
    VALIDATION_DIR,  # 경로 주의
    target_size=(300, 300),
    batch_size=32,
    class_mode='binary',
)
...
model = Sequential([
    ...
    Dense(1, activation='sigmoid')  # 이진분류: Dense1, sigmoid
])
