# -*- coding: utf-8 -*-
"""5.(실습)Sequences모델_household electric power consumption

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GXMx-AUZ0D0KIZwNbb_rhmOG-I63ekEg
...
def windowed_dataset(series, batch_size, n_past=24, n_future=24, shift=1):
    ds = tf.data.Dataset.from_tensor_slices(series) # dataset으로 변환 
    ds = ds.window(size=(n_past + n_future), shift = shift, drop_remainder = True) #window dataset 
