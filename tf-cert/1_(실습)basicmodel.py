...
Original file is located at
    https://colab.research.google.com/drive/1wRtCmzNdTiA_GWEazbabAjhtgMpXRB2v
...
model = Sequential([   # Sequential: list형태로 작성 
    Dense(3, input_shape=[1]),  # input_shape : 튜플형태도 가능  input_shape = (1,) 반드시 , 찍어준다!! 
    Dense(4),
    Dense(4),
    Dense(1),
])
...
model = Sequential([
    Dense(1, input_shape=[1]),  # 1페어씩 들어가기 때문에 input_shape=[1]
])
...
model.fit(xs, ys, epochs=1200, verbose=0) # verbose : 로그 출력
